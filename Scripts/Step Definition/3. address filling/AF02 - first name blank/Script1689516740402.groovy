...
WebUI.callTestCase(findTestCase('Pages/3. checkout/input first name'), [('firstname') : ''], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/3. checkout/input last name'), [('lastname') : 'Labs'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/3. checkout/input postal code'), [('postalcode') : '9669'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/3. checkout/continue to invoice'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/3. checkout/read checkout error message'), [ expected : 'Error: First Name is required'], 
